...
FINAL_IMAGE=${DISTDIR}/Zadanie5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Zadanie5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
